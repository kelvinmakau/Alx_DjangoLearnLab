...
from . import views
from .views import PostListView, PostDetailView, PostCreateView, PostUpdateView, PostDeleteView, CommentDeleteView, CommentCreateView
...
urlpatterns = [
    ...
    # comments
    path('comment/<int:pk>/update/', CommentCreateView.as_view(), name='comment-edit'),
